...
if __name__ == "__main__":
    ...
    df_obs["e_m_fin"] = df_obs.apply(apply_calculate_e_m_fin_scenario_1_inflation, axis=1)
    df_obs["price_deviation"] = df_obs.apply(lambda row: row["e_m_fin"] - row["median"], axis=1)
    df_obs["price_deviation"] = df_obs["price_deviation"].apply(lambda x: x.quantize(Decimal("0.01"), rounding=ROUND_HALF_UP))
