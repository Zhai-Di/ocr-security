...
if __name__ == "__main__":
    ...
    # 以下是第一个对比图
    # plt.scatter(x, y_1, color=colors[6], s=2, marker='o', alpha=0.7, label="f=10 in Median(Scenario I)")
    # plt.scatter(x, y_2, color=colors[1], s=5, marker='o', alpha=0.8, label="f=10 in Median(Scenario II)")
    # plt.scatter(x, y_5, color=colors[3], s=5, marker='o', alpha=1, label="f=6 in Dolev")
    # plt.scatter(x, y_6, color=colors[5], s=5, marker='o', alpha=1, label="f=5 in Dolev")
    # 以下是第二个对比图
